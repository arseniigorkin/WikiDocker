...
class ParserAfterTidyHook
{
    public static function onParserAfterTidy(Parser $parser, &$text)
    {
        ...
        $text = preg_replace_callback(
            ...
            function ($matches) use ($vcData, $output, $dbw) {
                $logger = \MediaWiki\Logger\LoggerFactory::getInstance( 'VCSystem' );
                ...
                $newSrc = self::getFileUrl($oldSrc, $vcData, $output, $dbw);
                if ($newSrc === null) {
    ...
    public static function getFileUrl(string &$path, stdClass &$vcData, OutputPage &$output, IDatabase &$dbw){
