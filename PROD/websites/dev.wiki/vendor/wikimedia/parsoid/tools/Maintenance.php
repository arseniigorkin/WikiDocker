...
//	require_once getenv( 'MW_INSTALL_PATH' ) . '/vendor/autoload.php';
//	require_once '/home/gpidru/web/dev.wiki.gpid.ru/public_html/vendor/autoload.php';
//    require_once __DIR__ . '/OptsProcessor.php';
//    require_once __DIR__ . '/ExtendedOptsProcessor.php';
